Pod::Spec.new do |s|
  s.name         = 'TTTAttributedLabel-HYW'
  s.version      = '2.0.0'
  s.authors      = { 'Mattt Thompson' => 'm@mattt.me' }
  s.homepage     = 'https://github.com/yongweihu/TTTAttributedLabel'
  s.platform     = :ios
  s.summary      = 'A drop-in replacement for UILabel that supports attributes, data detectors, links, and more.'
  s.source       = { :git => 'https://github.com/yongweihu/TTTAttributedLabel.git', :branch => "master" }
  s.license      = 'MIT'
